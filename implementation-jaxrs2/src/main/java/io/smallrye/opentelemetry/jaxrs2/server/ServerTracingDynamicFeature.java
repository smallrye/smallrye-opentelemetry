...
import io.smallrye.opentelemetry.jaxrs2.server.OperationNameProvider.WildcardOperationName;
...
public class ServerTracingDynamicFeature implements DynamicFeature {
    ...
    public static class Builder {
        ...
        public Builder() {
            ...
            this.serializationSpanDecorators = Collections.singletonList(new InterceptorSpanDecorator.StandardTags());
