package io.smallrye.opentelemetry.implementation.propagation;
...
@Provider
public class OpenTelemetryResteasyThreadContext implements ThreadContext<Map<String, Object>> {
    @Override
