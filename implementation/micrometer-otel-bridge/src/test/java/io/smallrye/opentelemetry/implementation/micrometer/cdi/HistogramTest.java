...
@AddBeanClasses({ OpenTelemetryConfigProducer.class, InMemoryMetricExporter.class, InMemoryMetricExporterProvider.class,
        InMemorySpanExporter.class, InMemorySpanExporterProvider.class, HistogramTest.ManualHistogramBean.class })
public class HistogramTest {
    ...
    void histogramTest() {
        ...
        metricExporter.getFinishedMetricItems("testSummary", null).forEach(metric -> {
            assertThat(metric)
        ...
        metricExporter.getFinishedMetricItems("testSummary.max", null).forEach(metric -> {
            assertThat(metric)
                    .hasDescription("This is a test distribution summary")
        ...
        List<MetricData> finishedMetricItems = metricExporter.getFinishedMetricItems("testSummary.histogram", null);
